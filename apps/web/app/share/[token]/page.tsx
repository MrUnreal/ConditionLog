    ...
    <div className="mx-auto max-w-4xl px-4 py-8 animate-fade-in">
      ...
      <div className="mb-8">
        <div className="mb-2 flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary text-primary-foreground font-bold text-sm" aria-hidden="true">CL</div>
      ...
      <div className="mt-12 border-t pt-6 text-center text-sm text-muted-foreground">
        <div className="flex items-center justify-center gap-2 mb-2">
          <div className="flex h-6 w-6 items-center justify-center rounded-md bg-primary text-primary-foreground font-bold text-[10px]" aria-hidden="true">CL</div>
          <span className="font-semibold text-foreground">ConditionLog</span>
        </div>
        <p>Rental Property Condition Documentation</p>
        <p className="mt-1">
